...
export function SessionShell({ children, onSubmit, onCommand, inputDisabled = false, loading = false, mode = "BUILD", onModeToggle, onCommandPalette, model, statusText, }) {
