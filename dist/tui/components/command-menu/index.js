...
export function CommandMenu({ onClose, ctx }) {
    ...
    return (_jsx("box", { position: "absolute", top: 0, left: 0, width: "100%", height: "100%", children: _jsx("box", { backgroundColor: "rgba(0,0,0,150)", width: "100%", height: "100%", alignItems: "center", justifyContent: "center", children: _jsxs("box", { flexDirection: "column", backgroundColor: colors.dialogSurface, width: 70, padding: 1, gap: 1, children: [_jsx("input", { ref: inputRef, placeholder: "Type a command...", focused: true, onChange: handleChange, onSubmit: handleSubmit }), _jsx("scrollbox", { height: visibleHeight, children: filtered.map((cmd, i) => {
