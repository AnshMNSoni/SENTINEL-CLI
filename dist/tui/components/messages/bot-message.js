...
export function BotMessage({ parts, model, duration }) {
    ...
    return (_jsxs("box", { width: "100%", flexDirection: "column", paddingY: 1, children: [grouped.map((group, gi) => {
            ...
            }), (model || duration) && (_jsxs("box", { flexDirection: "row", gap: 1, paddingX: 1, paddingTop: 1, children: [model && (_jsx("text", { attributes: TextAttributes.DIM, fg: colors.info, children: model })), duration && (_jsxs("text", { attributes: TextAttributes.DIM, fg: colors.dimSeparator, children: [duration, "ms"] }))] }))] }));
}
