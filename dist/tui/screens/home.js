...
const QUICK_ACTIONS = [
    ...
    { cmdKey: "full-scan", label: "full-scan", description: "Run all available analyzers", color: "#F59E0B" },
    { cmdKey: "security", label: "security", description: "Comprehensive security audit", color: "#EF4444" },
