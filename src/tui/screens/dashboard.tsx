      ...
      <box flexDirection="row" gap={2} flexGrow={1}>
        ...
        >
          <box
            ...
            gap={1}
          >
            <text attributes={1} fg={colors.primary}>System Health</text>
          ...
          <box
            ...
            gap={1}
          >
                <text attributes={1} fg={colors.warning}>Quick Actions</text>
            <box flexDirection="column" gap={0.5}>
              {[
                ...
                <box key={action.cmd} flexDirection="row" gap={1}>
                  <text fg={action.color}>{"\u25B6"} {action.label}</text>
                </box>
              ))}
            </box>
          </box>
        ...
        >
          <box
            ...
            gap={1}
          >
            <text attributes={1} fg={colors.info}>Recent Activity</text>
            <text attributes={TextAttributes.DIM}>{sessionCount > 0 ? `${sessionCount} saved session(s)` : "No recent activity"}</text>
          </box>
          ...
          <box
            ...
            gap={1}
          >
            <text attributes={1} fg={colors.secure}>Ollama Models</text>
          ...
          <box
            ...
            gap={1}
          >
            <text attributes={1} fg={colors.primary}>Configuration</text>
            <box flexDirection="row" justifyContent="space-between">
              <text attributes={TextAttributes.DIM}>AI Providers:</text>
              <text>{providers.filter((p) => p.hasKey).length > 0 ? providers.filter((p) => p.hasKey).map((p) => p.provider).join(", ") : "none configured"}</text>
            </box>
            <box flexDirection="row" justifyContent="space-between">
